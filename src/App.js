      ...
      <div className="App">
        ...
        <div className="paragraph-text">
          ...
          <p>
            ...
            acute toxicity. This information is found in{' '}
            <a
              href="https://www.osha.gov/hazcom/appendix-a"
              target="_blank"
              rel="noreferrer"
            >
              Appendix A.1 in the HCS{' '}
            </a>
            and{' '}
            <a
        ...
        <div className="paragraph-text">
          <h2>References</h2>
          <p>OSHA Hazard Communication Standard (29 CFR 1910.1200).</p>
          <p>
          ...
          <p>
            ...
            that is continually under development. We will make every effort to
            keep this site current and to correct errors brought to our
            attention.
          </p>
          <p>
            The documents on this site may contain links to information created
            and maintained by other public and private organizations. Please be
            aware that we do not control or guarantee the accuracy, relevance,
            timeliness, or completeness of this outside information. Further,
            the inclusion of links to particular items is not intended to
            ...
            reference or the organization operating the site on which the
